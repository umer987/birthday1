  ...
  return (
    ...
    <div className="w-[400px]  h-screen flex flex-col items-center justify-center">
      ...
      <div id="card" className={`${cardClass}`} onClick={toggleCard}>     
        <div id="card-inside">
          <div className="wrap">
            <p>Happy Birthday, SYED MUHAMMAD UMER</p>
            <p>"Happy Birthday! 🎉 Wishing you a day filled with joy.</p>
            <p>
              I hope you have a very blessed birthday!
            </p>
            <p>
            laughter, and all the things that make you happiest.
            </p>
            <p>
            May this year bring you success, good health, and endless blessings. Enjoy your special day!"
            </p>
            <p className="signed">ANONYMOUS</p>
          </div>
        </div>
